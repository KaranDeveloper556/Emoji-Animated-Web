...
const Hero = () => {
    ...
    return (
        <section className="Hero_section relative">
            <div className="Content absolute px-8 py-10 w-dvh h-[100dvh] max-w-[100rem] z-[99] overflow-x-hidden">
                <div className="hero-text relative flex justify-center items-center gap-[4rem]" id="hero-text-1">
                    <div className="hero-univ text-[15rem] leading-none font-DisplayFont font-extrabold">Universal</div>
                ...
                <div className="hero-text relative flex justify-between items-center gap-[1rem]" id="hero-text-2">
                    <div className="hero-para relative top-3 max-w-[18rem] text-[1.5rem] font-SansSerif font-light">Make every message memorable with emojis that capture the moment and showcase your personality.</div>
                    <div className="hero-lang text-[15rem] leading-none font-DisplayFont font-extrabold">Language</div>
                </div>
            </div>
